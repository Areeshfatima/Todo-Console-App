...
class TodoManager:
    ...
    def add_task(self, title: str, description: str = "", priority: str = "none", tags: List[str] = None) -> int:
        """
        ...
        Raises:
            ValueError: If the title is empty after stripping whitespace or priority is invalid
        """
    ...
    def display_tasks(self) -> str:
        ...
        Returns:
            str: Formatted string representation of all tasks with ID, status indicator,
                 priority indicator, tags, title, and description
        """
        ...
        for task in self.task_list:
            ...
            line = f"{task.id}. {status_indicator} {priority_indicator}{tags_str} {task.title}"
    ...
    def update_task(self, task_id: int, title: Optional[str] = None, description: Optional[str] = None, completed: Optional[bool] = None, priority: Optional[str] = None, tags: Optional[List[str]] = None) -> bool:
        """
